...
{% figuregroup "3", "mark-8-1, mark-8-2, mark-8-3" %}
...
{% figure "inscription-8-1" "pdf-two-column" %}
...
{% cite 'Solodkoff 2000' %}; {% cite '*Machine d’argent* 2004' %}; {% cite 'Burstyn 2005' %}, 24–25, 29n8, fig. 9; {% cite 'Solodkoff 2006' %}, figs. 1–4, 7; {% cite 'Frank 2007' %}, fig. 9; {% cite 'Fuhring 2008' %}, 49–60, 157, fig. 7; {% cite 'Sheriff 2009' %}, 160–61, fig. 3; {% cite 'Seelig 2011' %}; {% cite 'Bremer-David 2011' %}, 122, no. 37; {% cite 'Bremer-David 2015' %} 130, 132, 145–46n23, figs. 4, 12, 15.
...
[^18]: This weight in old French units of measure, that von Solodkoff equated to 5,235.419 grams, is somewhat less than the scratch weight given in Mecklenburg-Schwerin units that equate to 5,240 grams. See [note 2](#fn2) above and {% cite 'Solodkoff 2000' %}, 127, 135n17.
...
[^39]: Musée du Louvre, inv. OA 10923, https://collections.louvre.fr/en/ark:/53355/cl010104931. {% cite 'Alcouffe 1985' %}, 90–91, no. 37 (entry by Daniel Alcouffe); {% cite 'D’Orey 1993' %}, 306, no. 152; {% cite 'Perrin 1993' %}, frontispiece, 134–35, 156–57, 283n60; {% cite 'Bimbenet-Privat et al. 2022' %}.
