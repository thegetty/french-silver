...
{% figure "inscription-3-1" %}

{% figure "inscription-3-2" %}

##### Armorial

The exterior is engraved with the coat of arms of the Melo e Castro family, above crossed palm branches and surmounted by a Portuguese ducal coronet and the family crest of an eagle with spread wings ([armorial 3.1](#armorial-3-1)).[^1]
...
The interior, below the rim, is scratched with the Roman numeral “II” ([inscription 3.3](#inscription-3-3)). The bottom of the interior is incised with the numeral and weight “N° 2 - 48 m - 3 on. 2 g” ([inscription 3.4](#inscription-3-4)).[^3]

{% figure "inscription-3-3" %}

{% figure "inscription-3-4" %}
...
{% figure "inscription-3-6" %}

{% figure "inscription-3-7" %}
...
The interior, below the rim, is scratched with the Roman numeral “I” ([inscription 3.8](#inscription-3-8)). The bottom of the interior is incised with the numeral and weight “N° 1 . 48 m - 1 on. - 2 g –” ([inscription 3.9](#inscription-3-9)).[^5]
...
Each side bears a cartouche chased and engraved with the coat of arms of the Melo e Castro family, above crossed palm branches and surmounted by a Portuguese ducal coronet (see [cat. 3.6](#cat-3-6)).
...
Incised, underneath, with “FAIT.PAR.F.T.GERMAIN.ORF.SCULP.DU.ROY.AUX GALLERIES.DU LOUVRE.APARIS. 1764” (“MADE.BY.F.T.GERMAIN.GOLDS[MITH].SCULP[TOR].OF THE.KING.AT THE GALLERIES. OF THE LOUVRE.IN PARIS”) and with the numeral and weight “n°. 2. 48[m.]5[o]” ([cat. 3.1](#cat-3-1)).[^6]
...
[^6]: The historic weight, in the old French units of *marc*, *once*, and *gros*, on this stand (82.DG.12.2.c) equates to 11,901.114 grams which clearly tabulated more parts of the original pair “n^o^ 2” than the stand alone, whose weight is 3,320 grams. See [note 4](#fn4) above.
...
[^20]: The paneling is now installed in the Israel Museum, Jerusalem, https://www.imj.org.il/en/collections/202145. For a summary of the aggrandizement of the townhouse at 46 rue de Bac and a period floor plan indicating the new grand salon and gallery, see {% cite 'Boiron 2019' %}. On the relationship between Jean-Baptiste Oudry and the Germain workshop, see [cat. no. 8](/catalogue/8/) in this catalogue.
