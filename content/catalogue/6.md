...
The scratched alphanumeric string (see [**inscription 6.8**](#_top)) is consistent with a similar string on the water fountain ([cat. no. 1](/catalogue/1/)), an object that passed through the dealer Jacques Helft in the mid-twentieth century, as did this pair of tureens on stands.
