...
{% figure "inscription-6-1" %}

{% figure "inscription-6-2" %}
...
Struck, underneath, with the following stamps: possibly a crowned *K* (the Paris warden’s mark used between July 15, 1750, and January 22, 1752); possibly a crowned *A* (the Paris charge mark for works of silver used between October 1, 1744, and October 1, 1750, under the fermier Antoine Leschaudel); and a boar head (the Paris discharge mark for large works of silver used between October 1, 1750, and October 1, 1756, under the fermier Julien Berthe) ([mark 6.2](#mark-6-2)). Struck, on the exterior of the rim, with the following stamp: a laurel leaf (the Paris countermark for all works of gold and silver used between October 1, 1756, and October 1, 1762, under the fermiers Éloy Brichard and Étienne Somfoye) ([mark 6.3](#mark-6-3)).
...
The exterior of the rim is scratched with the Roman numeral “II” ([inscription 6.3](#inscription-6-3)). Underneath is incised “Du No. 3” ([inscription 6.4](#inscription-6-4)).

{% figure "inscription-6-3" %}

{% figure "inscription-6-4" %}
...
The interior, near the top, is scratched with the Roman numeral “II.” The bottom of the interior is incised “DU No 3” (effaced) ([inscription 6.5](#inscription-6-5)).

{% figure "inscription-6-5" %}
...
The exterior of the rim is scratched with the Roman numeral “I.” Underneath is incised “DU No 4” ([inscription 6.10](#inscription-6-10)).

{% figure "inscription-6-10" %}
...
The interior, near the top, is scratched with the Roman numeral “I” ([inscription 6.11](#inscription-6-11)). The bottom of the interior is incised “DU No 4” (effaced) ([inscription 6.12](#inscription-6-12)).

{% figure "inscription-6-11" %}

{% figure "inscription-6-12" %}
...
Underneath is incised with the number and weight “N^o^ 4 - 41[^m^] - 4[^o^] - 1^[g]^” ([inscription 6.13](#inscription-6-13)) and scratched with the following notes in English: “No 180 2 Terrines oz 423 - 5 / 181 2 Stands oz 206 = 629 – 5,” “6743 627010 IN / 6743 627010 tplt xx Pair,” and other indecipherable marks.[^2]

{% figure "inscription-6-13" %}
...
In terms of style, the shape of these lidded tureens and their finials, as well as the ornament on their stands, express the prevailing Rococo taste, with its fascination and delight in the natural world of minerals, water, crustaceans, and vegetables, as visualized in the *Livre de legumes* by Juste-Aurèle Meissonnier, of 1734–38 ([fig. 6.1](#fig-6-1)).[^14] Thomas Germain was aware of Meissonnier’s designs, for there was a volume of his contemporary’s work in his personal library at the time of his death.[^15]
